    ...
    <div class="container mx-auto p-4">
        ...
        <p>Pomodoro Count: <span id="pomodoroCount">0</span></p>
            ...
            <div class="flex justify-center">
                ...
                <button id="idk" class="bg-purple-500 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline ml-2" onclick="idk()">Switch Mode</button>
            </div>
        </div>
    </div>
    @php
